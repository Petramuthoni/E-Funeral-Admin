...
public class funeralrequestViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
  ...
  //  public Button cancel,accept;
    ...
    public funeralrequestViewHolder(@NonNull View itemView) {
        super(itemView);
